...
- (void)ac_initSubViews
{
    ...
    [self.backButton setImage:[[UIImage imageNamed:@"navigationButtonReturn"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
    ...
    [listButton setImage:[[UIImage imageNamed:@"icon_all-categories"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
...
- (void)showOrHideListTableViewAction:(UIButton *)button
{
    ...
    [UIView animateWithDuration:.3 animations:^{
        ...
        [self.listTableView mas_updateConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.view).offset(self.isHidenListView?0:300);
        }];
